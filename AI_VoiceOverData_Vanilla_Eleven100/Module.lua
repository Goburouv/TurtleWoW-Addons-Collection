...
AI_VoiceOverData_Vanilla_Eleven100 = {}

function AI_VoiceOverData_Vanilla_Eleven100:GetSoundPath(fileName, event)
    setfenv(1, VoiceOver)
...
VoiceOver.DataModules:Register("AI_VoiceOverData_Vanilla_Eleven100", AI_VoiceOverData_Vanilla_Eleven100)
